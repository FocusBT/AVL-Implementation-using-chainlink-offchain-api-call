...
contract MyToken is ERC20, ChainlinkClient, ConfirmedOwner  {
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        bytes32 requID = checkIfAllowedOrNot(recipient);
        require(callerToAddress[requID]!=recipient, "PLEASE WAIT YOU ARE BEING CHECKED"); // USER CAN NOT USE ANOTHER FUNCTION WHILE BEING CHECKED
        callerToAddress[requID] = recipient;
